---
title: "Operational Safety Concept"
subtitle: "For the laboratories and workshops of Global Health Engineering"
number-sections: true
format: html
toc: true
---

# Scope of the operational safety concept {#scope}
...
## Organizational structure {#organization_ii}
...
## How to play it safe at ETH Zurich {#emergency_i}
...
## Emergencies in the lab and workshop {#emergency_ii}
...
## Reporting lab and workshop incidents {#emergency_iii}
...
### Personal injury (personal accident, occupational accident, near miss) {#emergency_iii_a}
...
### Damage of material and equipment {#emergency_iii_b}
...
# Hazard identification and risk assessment {#hazard}
...
## Reporting requirements {#hazard_i}
...
## Project list and workflows {#hazard_ii}

The professor and the GSR maintain an overview of the safety-relevant activities within GHE and record these in [Appendix 1. Project list](_operational/01_project_list.html) and [Appendix 2. Description of workflows and activities](_operational/02_description_of_workflows_and_activities.html).

The professor and the GSR periodically examine all the workstations and processes for hazards, e.g., machines, equipment, tools, means of transport, heavy loads, or hazardous substances (chemicals). The findings are collected in [Appendix 3](_operational/03_hazard_identification_and_risk_assessment.html).
...
## Access control and work area identification {#measures_i}
...
The research group regulates diverse aspects of occupational and environmental safety in operating instructions, work guidelines or SOPs. These documents are filed electronically in [Appendix 4](_operational/04_operating_instructions_user_manuals_SOPs.html).

### Laboratory and workshop safety rules {#measures_ii_b}

Employees of GHE adhere to the legally binding regulations, the respective SUVA and EKAS publications, as well as ETH-internal directives (downloadable from the SSHE [Website](https://ethz.ch/services/en/service/safety-security-health-environment.html)). The laboratory/workshop rules summarise the key points, "EKAS directive no. 1871 "Chemical laboratories", the ETH factsheet "Working Alone", lab rules in [Appendix 5](_operational/05_general_lab_workshop_rules.html) and this safety concept.

## Guidelines for lab cleaning {#measures_iii}

External cleaning staff clean the lab and workshops according to the Service Level Agreement. Because of the hazards, special agreements and regulations apply for room CLA J26 and are written down in [Appendix 6](_operational/06_safety_regulations_for_cleaning.html).
...
## Purchase, maintenance, and upkeep of equipment {#measures_iv}
...
### Responsibility for equipment maintenance and upkeep {#measures_iv_a}
...
Maintenance schedules for individual devices and delegation of responsibilities are set down in writing in [Appendix 7](_operational/07_maintenance_and_service_schedule.html).

## Planning, building, rebuilding, dismantling, and relocating {#measures_v}
...
# Planning and realizing measures {#planning}

The identified hazards are eliminated or reduced to an acceptable degree with suitable measures. It should be ensured that the measures taken remain effective in the long term. The hazard and risk assessment ([Appendix 3](_operational/03_hazard_identification_and_risk_assessment.html)) lists the required measures, deadlines, and responsible persons. When a measure has been implemented, it is noted accordingly in the table. 

# Instruction, training, and information on operational safety {#training}
...
# Review and audits {#audits}

Global Health Engineering checks regularly if the safety and health protection goals have been reached and if safety rules are being applied. Furthermore, periodic clean-up activities are held in the lab and workshop facilities according to [Appendix 9](_operational/09_task_schedule.html).

# Appendices {#appendices}

- [Appendix 1: Project list](_operational/01_project_list.html)
- [Appendix 2: Description of workflows and activities](_operational/02_description_of_workflows_and_activities.html)
- [Appendix 3: Hazard identification and risk assessment](_operational/03_hazard_identification_and_risk_assessment.html)
- [Appendix 4: Collection of operating instructions, user manuals and SOP](_operational/04_operating_instructions_user_manuals_SOPs.html)
- [Appendix 5: General lab/workshop rules](_operational/05_general_lab_workshop_rules.html)
- [Appendix 6: Special safety regulations for lab/workshop cleaning by a cleaning service](_operational/06_safety_regulations_for_cleaning.html)
- [Appendix 7: Maintenance and servicing schedule](_operational/07_maintenance_and_service_schedule.html)
- [Appendix 8: Certificates of information, instruction, and training](_operational/08_training_certificates.html)
- [Appendix 9: Task schedule](_operational/09_task_schedule.html)
