...
This operational safety concept has been set-up by the Global Health Engineering (GHE) group. It constitutes the binding framework for the implementation of the legal and ETH-internal guidelines, which must be observed for activities in Global Health Engineering[ˆ1]. Incorporated in the operational safety concept are measures of GHE for workplace safety as well as measures to keep people and the environment safe.

This operational safety concept of GHE is based on the document «Safety and Occupational Health, Manual on the implementation of EKAS Directive 6508»[ˆ2] and the corresponding directive.
...
### <a name="organization1"></a>3.1 Responsibility and liability

The professor assumes, as head of the research group, the role of employer[ˆ3] and therewith the operational responsibility that the health and safety of all employees and students is warranted. The professor is responsible for:
...
The essential points regarding liability and insurance are listed in the SUVA publication «What are your duties in the field of occupational safety and health protection?»[ˆ3] as well as the corresponding [ETH factsheet](https://ethz.ch/content/dam/ethz/associates/services/finance-and-controlling/closed/Risikomanagement/merkblatt-versicherungen-ethzurich-nov.pdf).

### <a name="organization2"></a>3.2 Safety organization at GHE
...
### <a name="organization3"></a>3.3 Group Safety Representative
...
### <a name="organization4"></a>3.4 Employees, students, doctoral candidates, post-docs
...
### <a name="emergency1"></a>4.1 How to play it safe at ETH Zurich
...
### <a name="emergency2"></a>4.2 Emergencies in the lab and workshop
...
### <a name="emergency3"></a>4.3 Reporting lab and workshop incidents
...
#### <a name="emergency3a"></a>4.3.1 Personal injury (personal accident, occupational accident, near miss)
...
#### <a name="emergency3b"></a>4.3.2 Damage of material and equipment
...
### <a name="hazard1"></a>5.1 Reporting requirements
...
### <a name="hazard2"></a>5.2 Project list and workflows
...
#### <a name="measures2b"></a>6.2.2 Laboratory and workshop safety rules
...
### <a name="measures3"></a>6.3 Guidelines for lab cleaning



---

[ˆ1]: 832.30 Ordinance on Accident and Occupational Diseases Prevention
[ˆ2]: Safety and Occupational Health | Manual for the implementation of EKAS Directive 6508
[ˆ3]: SUVA: «What are your duties in the field of occupational safety and health protection?», SBA 140.D
[ˆ4]: These labeling materials can be obtained from [stickers@ethz.ch](mailto:stickers@ethz.ch). The catalog is available on the SSHE [Website](https://ethz.ch/content/dam/ethz/associates/services/Service/sicherheit-gesundheit-umwelt/files/kennzeichnungsmaterial/en/Bestellkatalog_EN_20210217.pdf).