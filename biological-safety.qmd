...
The duties of the BSO and PL are described in detail in [Appendix 1](_biological/01_duties_of_BSO_and_project_leaders.html).

## List of employees {#organization_iii}

Group 2 microorganisms represent a potential hazard for employees. GHE keeps a list of persons who work with Group 2 organisms (see [Appendix 2](_biological/02_list_of_employees_SAMV.html)) and, if required, arranges for a health file to be created according to the Ordinance on the Protection of Personnel from Hazards due to Microorganisms (SAMV) (see [Chapter 4.4](#emergency_iv)). GHE shall provide this list to SSHE-BSO upon request.
...
- [Appendix 1. Duties of Biosafety Officer and Project Leaders](_biological/01_duties_of_BSO_and_project_leaders.html)
- [Appendix 2. List of employees according to SAMV](_biological/02_list_of_employees_SAMV.html)
- [Appendix 3. Emergency telephone numbers and contacts for safety issues](_biological/03_emergency_telephone_numbers_and_contacts_for_safety.html)
- [Appendix 4. Emergency planning: Procedures in case of incidents in the laboratory](_biological/04_emergency_planning_and_procedures.html)
- [Appendix 5. Report sheet for laboratory incidents](_biological/05_report_sheet_for_lab_incidents.html)
- [Appendix 6. Project list](_biological/06_project_list.html)
- [Appendix 7. User list with access to level 2 working areas](_biological/07_user_list_with_access_to_BSL2.html)
- [Appendix 8. Meaning and use of the «Biohazard» warning symbol](_biological/08_meaning_and_use_of_biohazard_symbol.html)
- [Appendix 9. Standard Operating Procedures](_biological/09_SOPs.html)
- [Appendix 10. Use of class 2 safety cabinets](_biological/10_use_of_class_2_cabinets.html)
- [Appendix 11. Hygiene plan](_biological/11_hygene_plan.html)
- [Appendix 12. Safety during cleaning of laboratories by the cleaning service](_biological/12_safety_for_cleaning_service.html)
- [Appendix 13. Equipment service plan and responsibilities](_biological/13_service_plan.html)
- [Appendix 14. Disposal plan for biologically contaminated waste](_biological/14_disposal_plan_for_bio_contaminated_waste.html)
