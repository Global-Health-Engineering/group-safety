...
### Safety goggles
- Always wear safety goggles when handling hexane. Corrective glasses are not considered safety googles.
- Handle hexane inside the fume hood only (with exception of moving the closed bottle to and from the storage cabinet).
