---
title: "HACH LCK314 COD CUVETTE TEST"
format: html
---
...
## Basic information
- Chemical formula(s): Contains ${\rm H_2SO_4}$ (sulfuric acid, 80-90%), ${\rm HgSO_4}$ (mercury sulfate, 1-5%), ${\rm Ag_2SO_4}$ (silver sulfate, <1%), ${\rm K_2Cr_2O_7}$ (potassium dichromate, <0.1%)
- Other names: LCK314 CSB/COD/DCO Sample cuvette, Chemical Oxygen Demand test kit
- Product Code: LCK314
- Unique Formula Identifier (UFI): 9A3A-7FK3-480S-FK4P
- International Chemical Safety Card (ICSC): N/A - multiple components (see [Hach safety card](Hach_LCK314.pdf))
- Flammability: no
...
![](../media/nfpa704/302_OX_COR.png){width=15% fig-align="center"}
...
- **Nitrile**: **fair** - suitable for short-term contact only (>30 minutes breakthrough time, 0.40 mm thickness).
